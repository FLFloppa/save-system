...
{
    [CustomEditor(typeof(AppDataPathStrategyAsset))]
    public sealed class AppDataPathStrategyAssetEditor : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            root.Add(InspectorUi.Layout.CreateHeader(
                ...
                "Resolves save data under `Application.persistentDataPath` with an optional subdirectory."));
            ...
            void RefreshPreview()
            {
                try
                {
                    var strategy = ((AppDataPathStrategyAsset)target).Build();
